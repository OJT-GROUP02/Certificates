...
11	Graduate School	Main Campus	Legazpi City, Albay	(052) 481-7881
\.
...
COPY public.registrar (registrar_id, registrar_name, registrar_position, college_id) FROM stdin;
1	Corazon N. Bazar	University Registrar	\N
2	Sophia A. Romero	Registrar II	10
5	Catherine D. Lagata	Registrar II	11
6	Registrar sa CN	Registrar II	3
\.
...
2	Imee Janine	Ordonia	Abalon	F	2.01	\N	2015-03-28	3	2
\.
...
SELECT pg_catalog.setval('public.registrar_registrar_id_seq', 6, true);
